 ...
 * Fixed: ShortMessage send issue has fixed. To see short message field in single product. Use: `add_action( 'woocommerce_before_add_to_cart_quantity', 'wpt_add_custom_message_field' );`
